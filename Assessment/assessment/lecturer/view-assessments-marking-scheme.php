            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Marking Scheme" disabled></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                             ...
                             <tr>
                              ...
                              <td>'.$row["sub_assessment_deadline"].'</td>
                                ...
                                <td class="text-center">
                                  <button type="button" class="btn btn-success"><a href="marking-scheme.php?id=' . $assessment . '">Create MS</a></button>
                                </td>
                              </tr>
                              </div>
                            ';
